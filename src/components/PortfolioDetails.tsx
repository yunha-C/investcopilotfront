...
export const PortfolioDetails: React.FC = () => {
  const { activePortfolio, setCurrentStep, deletePortfolio } =
    useInvestmentStore();
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center py-8">
              ...
              <button
                ...
                className="bg-neutral-100 text-black py-3 px-6 rounded-lg text-label-large font-medium hover:bg-neutral-900 hover:text-white transition-colors"
              >
                Go to Home
              </button>
            </div>
              ...
              <div className="grid lg:grid-cols-3 gap-8 mb-8">
                <div className="lg:col-span-2">
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                    Holdings: {portfolio.holdings?.length || 0} | Allocation:{" "}
                    {portfolio.allocation?.length || 0} | Has Holdings Data:{" "}
                    {!!portfolio.holdingsData &&
                    Object.keys(portfolio.holdingsData).length > 0
                      ? "Yes"
                      : "No"}
                  </div>
                  <PortfolioChart
                ...
                <div className="space-y-6">
                  <div className="bg-neutral-100/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-positive text-label-large font-medium">
                          +{portfolio.growth}%
                        </span>
                        <span className="text-neutral-500 dark:text-dark-text-muted text-body-small">
                          +$320.00
                        </span>
                      </div>
                      <div className="pt-2 border-t border-neutral-300 dark:border-gray-600">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-body-small font-medium text-neutral-900 dark:text-dark-text-primary">
                            ${portfolio.monthlyFee?.toFixed(2) || "0.00"}
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-neutral-100/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-body-small text-neutral-700 dark:text-dark-text-secondary">
                          Annual Rate
                        </span>
                  ...
                  <div className="bg-neutral-100/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg p-6">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                      Raw Holdings Data:{" "}
                      {JSON.stringify(portfolio.holdingsData)}
                    </div>
                    <div className="space-y-3">
                      {portfolio.holdings && portfolio.holdings.length > 0
                        ? portfolio.holdings.map((holding, index) => {
                            ...
                            const gainLoss =
                              holding.marketValue -
                              holding.shares * holding.averageCostBasis;
                            const gainLossPercentage =
                              holding.shares * holding.averageCostBasis > 0
                                ? (gainLoss /
                                    (holding.shares *
                            ...
                            return (
                              <div
                                key={holding.id}
                                className="flex items-center justify-between py-3 border-b border-neutral-200 dark:border-gray-600 last:border-b-0"
                              >
                            ...
                            >
                              ...
                              <div className="text-right">
                                ...
                                <p className="text-body-small text-neutral-500 dark:text-dark-text-muted">
                                  $
                                  {(
                                    (portfolio.totalValue * asset.percentage) /
                                    100
                                  ).toLocaleString()}
                                </p>
                              </div>
                ...
                <div>
                  ...
                  portfolio.appliedMarketInsights.length === 0 ? (
                    <div className="bg-neutral-100/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg p-6 text-center">
                      <p className="text-body-medium text-neutral-500 dark:text-dark-text-muted mb-2">
                    ...
                    <div className="space-y-4">
                      {portfolio.appliedMarketInsights
                        ...
                        .map((insight, index) => (
                          <div
                            key={index}
                            className="bg-white/80 dark:bg-dark-surface-secondary/80 backdrop-blur-sm border border-neutral-200 dark:border-gray-600 rounded-lg p-4"
                          >
                            ...
                            {insight.trading_actions &&
                              insight.trading_actions.length > 0 && (
                                <div className="mb-3">
                            ...
                            <div className="flex items-center justify-end">
                              {insight.execution_summary &&
                                insight.execution_summary.successful_trades >
                                  0 && (
