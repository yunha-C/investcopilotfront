            ...
            <div className="p-8">
              {isAnalyzing ? (
                <div className="text-center py-16">
                  <div className="w-16 h-16 border-4 border-neutral-300 border-t-neutral-900 rounded-full animate-spin mx-auto mb-6"></div>
                  ...
                  <div className="max-w-md mx-auto">
                    <div className="space-y-2 text-body-small text-neutral-500">
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-neutral-100 rounded-lg p-6">
                    <div className="flex items-start gap-4 mb-4">
                      <div className={`p-2 rounded-lg ${
                        ...
                        analysisResult.confidence >= 60 ? 'bg-warning/10' : 'bg-neutral-200'
                      }`}>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mb-3">
                          <span className={`text-body-small font-medium px-2 py-1 rounded-full ${
                            ...
                            analysisResult.confidence >= 60 ? 'bg-warning/20 text-warning' : 'bg-neutral-200 text-neutral-700'
                          }`}>
                          ...
                          <a 
                            ...
                            className="flex items-center gap-1 text-body-small text-neutral-600 hover:text-neutral-800"
                          >
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-white border border-neutral-200 rounded-lg p-6">
                      <h4 className="text-title-medium font-headline font-semi-bold text-neutral-900 mb-3">
                        Portfolio Impact
                      </h4>
                      <p className="text-body-medium text-neutral-700 mb-4">
                        {analysisResult.impact}
                      </p>
                      <div className="space-y-2">
                        <div className="flex justify-between text-body-small">
                          <span className="text-neutral-600">Risk Impact:</span>
                          <span className="font-medium">{analysisResult.riskImpact}</span>
                        </div>
                        <div className="flex justify-between text-body-small">
                          <span className="text-neutral-600">Return Impact:</span>
                          <span className="font-medium">{analysisResult.returnImpact}</span>
                        </div>
                      </div>
                    </div>
                  ...
                  {analysisResult.suggestedChanges.length > 0 && (
                    <div className="bg-white border border-neutral-200 rounded-lg p-6">
                      <h4 className="text-title-medium font-headline font-semi-bold text-neutral-900 mb-4">
                        Suggested Portfolio Changes
                      </h4>
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          <h5 className="text-label-large font-medium text-neutral-800 mb-3">Current Allocation</h5>
                          <PortfolioChart allocation={portfolio.allocation} size="small" />
                        </div>
                        <div>
                          <h5 className="text-label-large font-medium text-neutral-800 mb-3">Proposed Changes</h5>
                    ...
                    {analysisResult.suggestedChanges.length > 0 ? (
                      <>
                        ...
                        <button
                          ...
                          className="flex-1 border-2 border-neutral-300 text-neutral-700 py-4 px-6 rounded-lg text-label-large font-medium hover:bg-neutral-100 transition-colors"
                        >
                      ...
                      <button
                        onClick={handleSaveForFuture}
                        className="flex-1 bg-neutral-900 text-white py-4 px-6 rounded-lg text-label-large font-medium hover:bg-neutral-800 transition-colors"
                      >
