...
export const Header: React.FC = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
      isScrolled 
        ? 'bg-white/95 dark:bg-dark-surface-primary/95 backdrop-blur-md shadow-elevation-2 dark:shadow-dark-elevation-2 border-b border-neutral-200/50 dark:border-dark-border-primary/50' 
